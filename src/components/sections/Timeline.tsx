...
export function Timeline() {
  return (
    <section
      id="journey"
      className="flex w-full scroll-mt-[110px] flex-col gap-[30px] bg-white px-[15px] py-[60px] tablet:gap-[50px] tablet:px-[30px] tablet:py-[50px] desktop:gap-[60px] desktop:px-[64px] desktop:py-[60px]"
    >
